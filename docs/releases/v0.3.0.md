...
- Initial JavaScript: 101,723 gzip bytes. Limit: 204,800 bytes.
- CSS: 4,536 gzip bytes. Limit: 51,200 bytes.
- Explorer logic: 97.1 percent statement coverage and 89.7 percent branch
  coverage.
- Route, interaction, and accessibility-contract tests: 32 passing tests.
...
- Live browser proof: 36 of 36 managed steps passed at 360, 768, 1,440,
  and 2,560 pixels. Run: `run-20260819T014259.436-65040-001`.
- Static browser proof: the same 36 steps passed, including direct route
  reloads. Run: `run-20260819T014312.402-65809-001`.
