# Nicos Catalog v0.3.0 release candidate

Status on 2026-08-18: **built and locally publish-ready**. The public tag,
GitHub Release, module-proxy result, deployment, launch, and adoption are not
claimed until direct evidence exists.
...
- Initial JavaScript: 101,719 gzip bytes. Limit: 204,800 bytes.
- CSS: 4,426 gzip bytes. Limit: 51,200 bytes.
- Explorer logic: 97.1 percent statement coverage and 89.7 percent branch
  coverage.
- Route and interaction tests: 30 passing tests.
...
- Live browser proof: 26 of 26 managed steps passed at 360, 768, 1,440,
  and 2,560 pixels. Run: `run-20260819T010850.288-37146-001`.
- Static browser proof: the same 26 steps passed, including direct route
  reloads. Run: `run-20260819T011042.314-45514-001`.
