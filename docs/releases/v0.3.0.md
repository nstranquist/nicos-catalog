...
Status on 2026-08-20: **public tag and GitHub Release exist**.
https://github.com/nstranquist/nicos-catalog/releases/tag/v0.3.0
`go list -m` and `go install …@v0.3.0` resolved from proxy.golang.org.
Deployment, launch, and adoption are not claimed.
